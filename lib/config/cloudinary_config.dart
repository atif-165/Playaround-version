...
class CloudinaryConfig {
  ...
  static const String apiSecret =
      'KYgrithib67nTQ67oYBYbZw2upU'; // Your API Secret

  // Upload settings
  static const String profileImagesFolder = 'profile_images';
  static const String shopLocationsFolder = 'shop_locations';
  static const String uploadPreset =
      'profile_images_preset'; // Add this when you create the preset
