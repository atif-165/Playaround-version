    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(16), // More rounded for sports feel
          side: BorderSide(
            color:
                ColorsManager.outline.withValues(alpha: 0.2), // Subtle border
            width: 1,
          ),
        ),
          ...
          overlayColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.hovered)) {
              return ColorsManager.secondary
                  .withValues(alpha: 0.1); // Orange hover
            }
            return null;
          }),
        ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor:
            ColorsManager.surfaceVariant.withValues(alpha: 0.5), // Darker fill
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(
              color: ColorsManager.primary, width: 2), // Red focus
        ),
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        unselectedItemColor:
            ColorsManager.textSecondary, // Light gray for inactive
        elevation: 8,
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            color: ColorsManager.primary
                .withValues(alpha: 0.2), // Subtle red border
            width: 1,
          ),
        ),
      ...
      textSelectionTheme: TextSelectionThemeData(
        ...
        selectionColor:
            ColorsManager.primary.withValues(alpha: 0.3), // Red selection
      ...
      listTileTheme: ListTileThemeData(
        ...
        selectedTileColor:
            ColorsManager.primary.withValues(alpha: 0.1), // Red selection
      ),
        ...
        trackColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return ColorsManager.primary
                .withValues(alpha: 0.5); // Red track when on
          }
          return ColorsManager.outline
              .withValues(alpha: 0.3); // Gray track when off
        }),
      ),
    );
  }
