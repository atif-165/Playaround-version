...
class ColorsManager {
  ...
  static const Color onPrimaryContainer = Color(0xFFFFFFFF); // White text on dark red
  ...
  static const Color secondaryContainer = Color(0xFF4D2000); // Dark orange container
  static const Color onSecondaryContainer = Color(0xFFFFFFFF); // White text on dark orange
  ...
  static const Color tertiaryContainer = Color(0xFF004D2A); // Dark green container
  static const Color onTertiaryContainer = Color(0xFFFFFFFF); // White text on dark green
  ...
  static const Color inverseSurface = Color(0xFFFFFFFF);  // White inverse surface
  static const Color onInverseSurface = Color(0xFF0D0D0D); // Black text on white
  static const Color inversePrimary = Color(0xFFFF3B30);  // Red remains consistent
  ...
  static const Color adminAccent = Color(0xFFFF6B00);     // Vibrant Orange for admins

  // Skill level colors (High Contrast for Dark Theme)
  static const Color beginnerColor = Color(0xFF00FF85);   // Neon Green for beginners
  static const Color intermediateColor = Color(0xFFFFC300); // Gold for intermediate
  ...
  static const Color proColor = Color(0xFFFF3B30);        // Red for pro (same as expert)
  ...
  static const Color neonBlue = Color(0xFF00D4FF);        // Neon blue for chat backgrounds
  static const Color chatBackground = Color(0xFF0A1A2A);  // Dark blue chat background

  // Text colors for dark theme
  static const Color textPrimary = Color(0xFFFFFFFF);     // White for headings/body
  static const Color textSecondary = Color(0xFFCCCCCC);   // Light gray for secondary text
  static const Color textTertiary = Color(0xFF999999);    // Medium gray for tertiary text
}
