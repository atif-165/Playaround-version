...
class AppConstants {
  ...
  static const String googleSignInFailedMessage = 'Google Sign In failed. Please try again.';
  
  /// Success messages
  static const String signUpSuccessMessage = 'You have successfully signed up.';
  static const String emailVerificationMessage = 'Don\'t forget to verify your email check inbox.';
  static const String passwordResetMessage = 'Link to Reset password send to your email, please check inbox messages.';
  ...
  static const String signUpSubtitle = 'Sign up now and start exploring all that our\napp has to offer. We\'re excited to welcome\nyou to our community!';
